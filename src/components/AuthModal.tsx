...
// make this more buetiful and add more features like forgot password, social login, etc. also add loading states and error handling. also make it responsive and mobile friendly.    
